...
const CalculateTable = (props) => {
  ...
  return (
    <div className="bold-letter">
      <div className="calculatetable box">
        <div className="main-table table-box width-50">
          ...
          />
          <div className="outsidelooking table-font">
      ...
      <div className="wrapper financing-area">
        <div className="financing-box width-40">
          <div className="wrapper payment-total">
            <div className="table-box width-50 flex-center">
              <p className="financing" style={{ textAlign: 'center' }}>
                Financing
              </p>
            </div>
            <div
              className="table-box width-50 fdm__box_center"
        ...
        <div className="total-form table-font width-60">
          <div>
            <p>
          ...
          <div>
            ...
            <Input
              addClass="black-text width-100px medium-input"
              type={'text'}
          ...
          <div>
            ...
            <input
              id="calculateInput1"
              className="bottom-outline black-text width-100px medium-input"
              type="text"
              style={{ textAlign: 'right' }}
          ...
          <div>
            ...
            <Input
              addClass="width-100px medium-input"
              type={'text'}
          ...
          <div className="wrapper">
            <div style={{ width: viewMode === 'convert-pdf' ? '40%' : '50%' }}>
              <label>Ck#</label>
              <input
                id="calculateInput3"
