  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        held responsible for delays caused by weather, manufacture delays,
        re-measures, customer rescheduling, or any other cause outside the
        control of Window World.
      </Paragraph>
      ...
      <Paragraph>
        ...
        through your home. It is advisable to gather together important papers,
        and other small items that can be disturbed by the wind and relocate
      ...
      <Paragraph>
        ...
        <b>
          ...
          completion. If this is not convenient for you, we need to know before
          we start the job. Inclement weather and other unforeseen hindrances
          are a fact of life and as such we ask that you understand if the
      ...
      <Paragraph>
        ...
        removal of old windows, setting the new window, wrapping of exterior,
        etc.), we don’t complete the job one window at a time. The job moves
        along in a rolling progression where each operation is done on all
        windows at the same time. This produces a quality job.
      </Paragraph>
      ...
      <Paragraph>
        ...
        description does not include scampering down the street after Fido with
        new found freedom. Many people say, don‘t worry, he doesn’t bite, but
        many installers have been bitten. So please secure dogs that have an
        aggressive bark towards strangers.
      </Paragraph>
      ...
      <Paragraph>
        ...
        understanding during the job and until everything is finished. Even
        after we have cleaned up, it is advisable to survey the areas for
        something we may have overlooked (i.e., kids rooms, baby’s room).
      </Paragraph>
      ...
      <Paragraph>
        ...
        very old, dry, and brittle, they may snap and crack upon removal. If
        this happens, we can leave them off if you please, or for a small up
        charge, replace them with newer ones. Many of the old style stops are no
        longer available so we would replace the entire window with newer style
        stops. Should we discover any hidden damage to the frame or wall area we
        will advise you before we proceed. Should you decide to replace or
        repair anything, the price will be added to your balance.
      </Paragraph>
      ...
      <Paragraph>
        ...
        what we do, and most customers are intrigued with the process. We do get
        nervous, however, when a customer constantly hovers over our shoulder.
        Like any professional, we’re always happy to answer questions, but we
        appreciate being able to concentrate on our work without interruptions
        and distractions. This ensures a safe and quality installation.
      </Paragraph>
