...
const PatioDoorOrder = () => {
  ...
  for (let m = 0; m < 10; m++) {
    checkIDs.push(`patio__form__CheckBox-1-1-${m + 1}`);
  }
  for (let m = 0; m < 12; m++) {
    checkIDs.push(`patio__form__CheckBox-1-2-${m + 1}`);
  }
  for (let m = 0; m < 6; m++) {
    checkIDs.push(`patio__form__CheckBox-1-3-${m + 1}`);
  }
  for (let m = 0; m < 9; m++) {
    checkIDs.push(`patio__form__CheckBox-2-1-${m + 1}`);
  }
  for (let m = 0; m < 14; m++) {
    checkIDs.push(`patio__form__CheckBox-2-2-${m + 1}`);
  }
  for (let m = 0; m < 15; m++) {
    checkIDs.push(`patio__form__CheckBox-2-3-${m + 1}`);
  }
  for (let m = 0; m < 15; m++) {
    checkIDs.push(`patio__form__CheckBox-2-4-${m + 1}`);
  }
  for (let m = 0; m < 3; m++) {
    checkIDs.push(`patio__form__CheckBox-3-2-${m + 1}`);
  }
        ...
        <div className="flex">
          <div className="col flex">
            <ul>
              ...
              <div className="patio__form__CheckBox patio__form__CheckBox-Width2">
                <Checkbox
              ...
              <div
                checkId="patio__form__CheckBox-1-1-2"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
                  updateCheck={handleChange}
              ...
              <div
                checkId="patio__form__CheckBox-1-1-3"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-1-4"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-1-5"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-1-6"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="col">
            <div className="flex">
              <ul>
                <div className="space"></div>
                <div
                  checkId="patio__form__CheckBox-1-1-7"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
                    updateCheck={handleChange}
                ...
                <div
                  checkId="patio__form__CheckBox-1-1-8"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div style={{ border: '3px solid black' }}>
              ...
              <div className="flex">
                <ul>
                  <div
                    checkId="patio__form__CheckBox-1-1-9"
                    className="patio__form__CheckBox patio__form__CheckBox-Width1"
                  >
                    <Checkbox
                      checkId={checkIDs[indexOfCheckIDs]}
                  ...
                  <div
                    checkId="patio__form__CheckBox-1-1-10"
                    className="patio__form__CheckBox patio__form__CheckBox-Width1"
                  >
                    <Checkbox
                      checkId={checkIDs[indexOfCheckIDs]}
      ...
      <div>
        ...
        <div className="flex">
          <div className="col flex">
            <ul>
              <div className="text-center underline bold">QTY</div>
              <div
                checkId="patio__form__CheckBox-1-2-1"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-2"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-3"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-4"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="col">
            <div className="flex">
              <ul>
                <div className="space"></div>
                <div
                  checkId="patio__form__CheckBox-1-2-5"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
                ...
                <div
                  checkId="patio__form__CheckBox-1-2-6"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
        ...
        <div className="flex">
          <div className="col flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-1-2-7"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-8"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-9"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-2-10"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="col">
            <div className="flex">
              <ul>
                <div className="space"></div>
                <div
                  checkId="patio__form__CheckBox-1-2-11"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
                ...
                <div
                  checkId="patio__form__CheckBox-1-2-12"
                  className="patio__form__CheckBox patio__form__CheckBox-Width1"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
        ...
        <div className="flex">
          <div className="col flex">
            <ul>
              <div className="text-center underline bold">QTY</div>
              <div
                checkId="patio__form__CheckBox-1-3-1"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-3-2"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-3-3"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div className="space"></div>
              <div
                checkId="patio__form__CheckBox-1-3-4"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-3-5"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-1-3-6"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
      ...
      <div className="col border" style={{ position: 'relative' }}>
        <div>
          ...
          <div className="flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-2-1-1"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-2"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-3"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-4"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-5"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-6"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-7"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-1-8"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
        ...
        <div style={{ position: 'absolute', bottom: '0px' }}>
          ...
          <div className="flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-2-1-9"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
    ...
    return (
      <div className="col border">
        ...
        <div className="flex">
          <ul>
            <div
              checkId="patio__form__CheckBox-2-2-1"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-2"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-3"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div className="space"></div>
            <div
              checkId="patio__form__CheckBox-2-2-4"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-5"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-6"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-7"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-8"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-9"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-10"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-11"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-12"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-13"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-2-14"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
    ...
    return (
      <div className="col border">
        ...
        <div className="flex">
          <ul>
            <div
              checkId="patio__form__CheckBox-2-3-1"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-2"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-3"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-4"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
        ...
        <div className="flex">
          <ul>
            <div
              checkId="patio__form__CheckBox-2-3-5"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-6"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-7"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-8"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-9"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-10"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
        ...
        <div className="flex">
          <ul>
            <div
              checkId="patio__form__CheckBox-2-3-11"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-12"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-13"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-14"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div
              checkId="patio__form__CheckBox-2-3-15"
              className="patio__form__CheckBox patio__form__CheckBox-Width2"
            >
              <Checkbox
                checkId={checkIDs[indexOfCheckIDs]}
  ...
  const Component_2_4 = () => {
    return (
      <div className="Height100 flex" style={{ flexDirection: 'row-reverse' }}>
        <div className="col border">
          <div className="text-center bold underline">SCREEN</div>
          <div className="flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-2-4-1"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="flex">
            <div className="flex">
              <ul>
                <div
                  checkId="patio__form__CheckBox-2-4-2"
                  className="patio__form__CheckBox patio__form__CheckBox-Width2"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
                ...
                <div
                  checkId="patio__form__CheckBox-2-4-3"
                  className="patio__form__CheckBox patio__form__CheckBox-Width2"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
            ...
            <div className="flex">
              <ul>
                <div
                  checkId="patio__form__CheckBox-2-4-4"
                  className="patio__form__CheckBox patio__form__CheckBox-Width2"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
                ...
                <div
                  checkId="patio__form__CheckBox-2-4-5"
                  className="patio__form__CheckBox patio__form__CheckBox-Width2"
                >
                  <Checkbox
                    checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-2-4-6"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-7"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-8"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-9"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-10"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
          ...
          <div className="flex">
            <ul>
              <div
                checkId="patio__form__CheckBox-2-4-11"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-12"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-13"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-14"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
              ...
              <div
                checkId="patio__form__CheckBox-2-4-15"
                className="patio__form__CheckBox patio__form__CheckBox-Width2"
              >
                <Checkbox
                  checkId={checkIDs[indexOfCheckIDs]}
...
<TempTag /> */}
      ...
      <div className="width-90 patio__form">
        <div className="BlackBar text-center white-color">
          1615/1617 Series patio__form Door
        </div>
        <div className="flex">
            ...
            <div className="flex space-between">
              ...
              <div className="col">
                <div className="flex">
                  <ul>
                    <div className="space"></div>
                    <div className="patio__form__CheckBox patio__form__CheckBox-Width1">
                      <Checkbox
                        checkId={checkIDs[indexOfCheckIDs]}
                        updateCheck={handleChange}
                        checkVal={storeData[checkIDs[indexOfCheckIDs++]]}
