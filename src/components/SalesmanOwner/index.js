...
const SalesmanOwner = () => {
  ...
  const handleChange = (value, { formId }) => {
    if (formId === 'owner') {
      ...
      if (formId === 'salesman') {
        dispatch(updateSalesInfo({ id: 'salesConsultant', value: value }));
      }
          ...
          >
            ...
            >
              <Input
                ...
                flag={false}
              />
              <label htmlFor="salesman" className="lbl">
                Salesman
              </label>
            </div>
            <div
            ...
            >
              <Input
                ...
                flag={false}
              />
              <label htmlFor="date2" className="lbl">
                Date
              </label>
            </div>
          </div>
          ...
          >
            ...
            >
              <Input
                ...
                flag={false}
              />
              <label htmlFor="owner" className="lbl">
                Owner
              </label>
            </div>
            <div
            ...
            >
              <Input
                ...
                flag={false}
              />
              <label htmlFor="date3" className="lbl">
                Date
              </label>
            </div>
          </div>
        ...
        <div className="wrapper-right">
          <div className="input-field email-form" style={{ marginTop: '15px' }}>
            ...
            <Input
              type={'text'}
              style={{
                width: viewMode === 'convert-pdf' ? '88%' : '90%',
                height: '100%',
                fontSize: viewMode === 'convert-pdf' ? '16px' : '30px',
                textAlign: 'left',
                color: 'blue',
