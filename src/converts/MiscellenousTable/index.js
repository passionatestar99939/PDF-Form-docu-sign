      ...
      <div>
        ...
        <div className="wrapper">
          <div className="flex-input" style={{ width: '70%' }}>
            ...
            <input
              className="bottom-outline input-box small-input"
              style={
                viewMode === 'convert-pdf' ? { width: '61%' } : { width: '71%' }
              }
              type="text"
        ...
        <div className="wrapper">
          <div className="flex-input" style={{ width: '70%' }}>
            ...
            />
            <input
              className="bottom-outline width-50px width-70 small-input"
              style={{ width: '89%' }}
              type="text"
        ...
        <div className="wrapper">
          <div className="flex-input" style={{ width: '70%' }}>
            ...
            />
            <input
              className="bottom-outline width-70 small-input"
              style={{ width: '89%' }}
              type="text"
